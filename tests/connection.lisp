...
<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"
  ...
  (testing "cheking sandbox environment"
    (with-dynamic-stubs ((dex:post "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"
                  xmlns=\"urn:partner.soap.sforce.com\"
                  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">
  <soapenv:Body>
    <loginResponse>
      ...
      (let* ((connection (cl-salesforce-bulk.connection:login "tamura.shingo@gmail.com" "password" "39.0" :sandbox-mode t))
             (params (nth-mock-args-for 1 'dex:post)))
        (declare (ignore connection))
        (ok (string= "https://test.salesforce.com/services/Soap/u/39.0" (car params)))))))
